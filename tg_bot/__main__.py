...
TECHNO_IMG = "https://telegra.ph/file/1007614014cfa0445bfce.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
SOURCE_STRING = """
[here](https://github.com/BLACKSTORM-18/BM_Group_Manager)
"""
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[
                     ...
                     [
                         ...
                         InlineKeyboardButton(
                             text="Channel",
                             url="https://t.me/BLACKSTORM18_Writings")
                     ],
                     [
                         InlineKeyboardButton(
                             text="💻 MY CREATOR 💻",
                             url="t.me/BLACKSTORM18")
                     ]]))

    else:
        update.effective_message.reply_text("╔═════════════════╗\n       「 🔥 𝗢𝗣 𝘽𝙊𝙏 🔥 」\n╚═════════════════╝",reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="🖤 ᴄᴏɴᴛᴀᴄᴛ ᴛᴏ ᴍᴇ ʜᴇʟᴘ 🖤",url="t.me/BLACKSTORM18_BOT?start".format(bot.username))]]))
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("ʜᴇʏᴀ, ᴄᴏɴᴛᴀᴄᴛ ᴍᴇ ɪɴ ᴘᴍ ᴛᴏ ɢᴇᴛ ᴛʜᴇ ʟɪsᴛ ᴏғ ᴛʜᴇ ᴀᴠᴀɪʟᴀʙʟᴇ ᴄᴏᴍᴍᴀɴᴅs.",
                                            reply_markup=InlineKeyboardMarkup(
                                                ...
                                                [InlineKeyboardButton(text="🔀 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ 🔀",url="https://t.me/freefirekerala18")]]))
    ...
    if chat.type == "private":
        ...
        try:
            ...
            update.effective_message.reply_text("sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ 🔥",reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="ᴄᴏɴᴛᴀᴄᴛ ᴍᴇ ᴘᴍ",url="t.me/BLACKSTORM18")]]))
        except Unauthorized:
